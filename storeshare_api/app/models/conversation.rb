class Conversation < ActiveRecord::Base
  ...
  #   where("(conversations.renter_id = ? AND conversations.subletter_id =?) OR (conversations.renter_id = ? AND conversations.subletter_id =?)", renter_id,subletter_id, subletter_id, renter_id)
  # end
end